...
window.saveScheduledRoutine=function(dayIdx,tplId){
 var d=cd();
 d.scheduledRoutines=d.scheduledRoutines||{};
 if(tplId){d.scheduledRoutines[dayIdx]=tplId;}
 else{delete d.scheduledRoutines[dayIdx];}
 st({data:d});tst(tplId?'✅ Rutina asignada':'Día sin rutina asignada');
};
