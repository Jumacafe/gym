...
function defaultData(){
 return {workouts:{},templates:[],customExercises:[],bodyWeight:[],workoutNotes:{},goals:{weeklySessions:4,customGoals:[]},reminders:{enabled:false,days:[0,1,2,3,4],time:'18:00'},settings:{weightUnit:'kg'},scheduledRoutines:{}};
}
...
(function initData(){
 ...
 if(saved){
  ...
  if(!S.data.scheduledRoutines)S.data.scheduledRoutines={};
 } else {
